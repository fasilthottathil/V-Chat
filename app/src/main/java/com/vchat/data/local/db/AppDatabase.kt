...
import com.vchat.data.local.db.dao.ChatDao
 ...
 */
@Database(entities = [UserEntity::class, PostEntity::class, ChatEntity::class, MessageEntity::class], version = 1, exportSchema = false)
